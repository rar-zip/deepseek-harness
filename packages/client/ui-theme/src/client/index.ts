...
export class ThemeRuntime {
  ...
  private buildSnapshot(): ThemeSnapshot {
    const resolvedId = this.preference === 'system'
      ...
      : this.preference
    // A persisted id may not be registered yet (curated/imported themes
    // register after this runtime adopts the durable preference at boot);
    // resolve to the light base until the matching theme registers and
    // republishes.
